...
(function () {
  ...
  function resize(e) {
    ...
    screenWidth = canvas.width = contribution.clientWidth - 20;
    screenHeight = canvas.height = contribution.clientHeight;
